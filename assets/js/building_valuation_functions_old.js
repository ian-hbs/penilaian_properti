...
{
    var $ry = $('#remain_year'), $by = $('#built_year'), $paa1 = $('#phys_act_age1'), $paa1_val = $('#phys_act_age1_val');
...
{
    var $by = $('#built_year'), $ry = $('#renov_year'), $ra = $('#remain_act'), $rr = $('#remain_rebuild'), $fr = $('#first_remain'), $fr_val = $('#first_remain_val');
...
function get_maintanance_adj()
{
    var $by = $('#built_year'), $_ry = $('#renov_year'), $ry = $('#remain_year'), $m = $('#maintanance'), $m_ = $('#maintanance_'), $m_val = $('#maintanance_val');
...
function get_total_adj(){
    var $m_ = $('#maintanance_'), $fr = $('#first_remain'), $t = $('#total_adjustment'), $t_val = $('#total_adjustment_val');
...
{
    var $by = $('#built_year'), $ry = $('#renov_year'), $pd2 = $('#phys_deter2'), $pd4 = $('#phys_deter4'), $pd = $('#phys_deter');
...
function get_cost_sqm2()
{
    ...
    if(psu>=100){
        ...
        cs2 = round((psu*li*psua:cs1*li),-5);
    else{
        //ROUND(IF(R41>=100,ROUND(R41*O41*$R$25,-5),IF(R41<100,S41*O41)),-4)
       cs2 = round((cs1*li),-4);
    }
...
function get_remain()
{
    var $fr = $('#first_remain'), $m_ = $('#maintanance_'), $r = $('#remain');
