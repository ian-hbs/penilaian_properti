<?php
	...
	if($act=='add')
	{
		...
		$activity = "menambah data ke table ref_penilai (id_penilai=".$arr_data['id_penilai'].")";
	...
	else if($act=='edit')
	{
		...
		$activity = "merubah data pada table ref_penilai (id_penilai=".$id.")";
		$global->insert_logs($activity,$ip);
	}
	else if($act=='delete')
	{
		...
		$activity = "menghapus data dari table ref_penilai (id_penilai=".$id.")";
		$global->insert_logs($activity,$ip);
	}	
