      ...
      <tbody>";
        ...
        while($row = $list_of_data->FetchRow())
        {
            ...
            <tr>
              ...
              <td>".$num_spesifikasi." lantai</td>
              <td align='center'>";

                  if($status=='0')
                    echo "<button type='button' title='Edit' class='btn btn-xs btn-default' id='manajemen_".$no."' data-toggle='modal' data-target='#formModal' onclick=\"load_manajemen_content(this.id);\">";
                  else
