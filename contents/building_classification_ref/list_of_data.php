<div class="box-header">
    <div class="row">
      <div class="col-md-6">
        <h3 class="box-title">Daftar Klasifikasi Bangunan</h3>
      </div>
                    ...
                    <tbody>";
                      ...
                      while($row = $list_of_data->FetchRow())
                      {
                          ...
                          <tr>
                            ...
                            <td align='center'>".$id_klasifikasi_bangunan."</td>
                            <td align='center'>";
                                ...
                                echo "
                                <input type='hidden' id='ajax-req-dt' name='id' value='".$id_klasifikasi_bangunan."'/>
