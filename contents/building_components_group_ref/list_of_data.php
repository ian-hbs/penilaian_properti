<div class="box-header">
    <div class="row">
      <div class="col-md-6">
        <h3 class="box-title">Daftar Kelompok Komponen Bangunan</h3>
      </div>
                    ...
                    <tbody>";
                      ...
                      while($row = $list_of_data->FetchRow())
                      {
                          ...
                          <tr>
                            ...
                            <td>".$diklasifikasi."</td>
                            <td align='right'>".$maks_inputan."</td>
                            <td align='center'>".$id_kelompok_komponen_bangunan."</td>
                            <td align='center'>";
                                if($editAccess)
                                ...
                                echo "
                                <input type='hidden' id='ajax-req-dt' name='id' value='".$id_kelompok_komponen_bangunan."'/>
