...
<section class="content-header">
  <h1>
    Data Pendukung 
    <small>Nilai Komponen Bangunan</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Penginputan</a></li>
    <li class="active">Nilai Komponen Bangunan</li>
  </ol>
</section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Form Nilai Komponen Bangunan</h4>
            </div>
