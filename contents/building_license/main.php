...
<script type="text/javascript">
    ...
    function load_form_content(id)
    {
        ...
        var masked_id = new Array(['tanggal_imb']);
...
<section class="content-header">
  <h1>
    Penilaian Properti 
    <small>Perijinan Bangunan</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Penilaian Properti</a></li>
    <li class="active">Perijinan Bangunan</li>
  </ol>
</section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Form Perijinan Bangunan</h4>
            </div>
