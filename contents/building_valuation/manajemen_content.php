<?php
    ...
    <div class='box'>
        <div class='box-header'>
            <div class='row'>
                <div class='col-md-6'>
                    <h3 class='box-title'>Real Estate Valuation</h3>
                </div>
                <div class='col-md-6' align='right'>";
                    ...
                    <input type='hidden' name='data_type' value='".$data_type."' id='ajax-req-dt'/>
                    <input type='hidden' name='jenis_perusahaan_penunjuk' value='".$jenis_perusahaan_penunjuk."' id='ajax-req-dt'/>
