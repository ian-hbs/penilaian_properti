<div class="box-header">
    <div class="row">
      <div class="col-md-6">
        <h3 class="box-title">Daftar Jenis Sertifikat</h3>
      </div>
        ...
        if($readAccess)
        {
            ...
            <table id='data-table-jq' class='table table-bordered table-striped'>
                    <thead>
                      <tr>
                        <th width='4%'>No.</th>
                        <th width='15%'>Jenis Sertifikat</th>
                        <th>Akronim</th>
                        <th width='10%'>ID</th>
                        <th width='10%'>Aksi</th>
                      </tr>
                    ...
                    <tbody>";
                      ...
                      while($row = $list_of_data->FetchRow())
                      {
                          ...
                          <tr>
                            ...
                            <td>".$akronim."</td>
                            <td align='center'>".$id_jenis_sertifikat."</td>
                            <td align='center'>";
                                if($editAccess)
                                ...
                                echo "
                                <input type='hidden' id='ajax-req-dt' name='id' value='".$id_jenis_sertifikat."'/>
