...
<section class="content-header">
  <h1>
    Data Pendukung
    <small>Jenis Sertifikat</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Data Pendukung</a></li>
    <li class="active">Jenis Sertifikat</li>
  </ol>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Form Jenis Sertifikat</h4>
            </div>
