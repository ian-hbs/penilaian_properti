...
<section class="content-header">
  <h1>
    Penilaian Properti 
    <small>Pertumbuhan Agunan</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Penilaian Properti</a></li>
    <li class="active">Pertumbuhan Agunan</li>
  </ol>
</section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Form Pertumbuhan Agunan</h4>
            </div>
