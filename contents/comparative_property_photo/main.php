...
<script type="text/javascript" src="<?=$_ASSETS_PATH?>js/ajax_upload.js"></script>
...
<input type="hidden" id="upload_ajax_form_id" value="comparative-property-photo-form"/>
<input type="hidden" id="upload_ajax_loader_id" value="preloadAnimation"/>
<input type="hidden" id="upload_ajax_content1_id" value="list-of-data1"/>
<input type="hidden" id="upload_ajax_content2_id" value="list-of-data2"/>
<input type="hidden" id="upload_ajax_table_id" value="data-table-jq"/>
<section class="content-header">
  <h1>
    Penilaian Properti 
    <small>Foto Pembanding</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Penilaian Properti</a></li>
    <li class="active">Foto Pembanding</li>
  </ol>
</section>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Manajemen Foto Pembanding</h4>
            </div>
