...
<form id="<?=$id_form?>" class="form-horizontal form-label-left" method="POST" action="contents/<?=$fn?>/manipulating.php">
    ...
    <div class="form-group">
        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="fee">Nilai Fee<font color="red">*</font></label>
        <div class="col-md-8 col-sm-8 col-xs-12">
            <input type="text" id="fee" name="fee" value="<?=$curr_data['fee']?>" class="form-control col-md-7 col-xs-12" onkeypress="return only_number(event,this);" required>
        </div>
    </div>    
