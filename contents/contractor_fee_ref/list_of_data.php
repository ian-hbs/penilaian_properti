<div class="box-header">
    <div class="row">
      <div class="col-md-6">
        <h3 class="box-title">Daftar Fee Kontraktor</h3>
      </div>
                    ...
                    <tbody>";
                      ...
                      while($row = $list_of_data->FetchRow())
                      {
                          ...
                          <tr>
                            ...
                            <td>".$fee."</td>                            
                            <td align='center'>".$id_fee_kontraktor."</td>
                            <td align='center'>";
                                if($editAccess)
                                ...
                                echo "
                                <input type='hidden' id='ajax-req-dt' name='id' value='".$id_fee_kontraktor."'/>
