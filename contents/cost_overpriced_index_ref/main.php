...
<script type="text/javascript">
    ...
    function load_form_content(id)
    {
        ...
        ajax_manipulate.set_plugin_datatable(false).set_url('contents/'+fn+'/form_content.php').set_id_input(id).set_input_ajax('ajax-req-dt').set_data_ajax().set_loading('#form-loading').set_content('#form-content').request_ajax();
    }
...
<section class="content-header">
  <h1>
    Data Pendukung
    <small>Indeks Kemahalan Konstruksi</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="#">Data Pendukung</a></li>
    <li class="active">Indeks Kemahalan Konstruksi</li>
  </ol>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="defModalHead">Form Indeks Kemahalan Konstruksi</h4>
            </div>
