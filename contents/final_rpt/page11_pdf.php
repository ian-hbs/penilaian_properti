<?php
	...
	$pdf->Cell(3,4,':');
	$text = $row1['alamat'].", Kelurahan ".ucwords(strtolower($row1['kelurahan'])).", Kecamatan ".ucwords(strtolower($row1['kecamatan'])).", "
            .ucwords(strtolower($row1['kota'])).", Provinsi ".ucwords(strtolower($row1['provinsi']));
    ...
    while($row2 = $result->FetchRow())
    {
        ...
        if($j==1)
        {        
            $photos[$i][$j] = array('file_foto'=>'','keterangan'=>'');
        }
    }
    ...
    {
        $_rows[] = array("N. PSR. SETELAH SAFETY MARGIN","C");
    }
    ...
    $text = "Berdasarkan surat penugasan No. ".$row1['no_penugasan']." alamat properti berada di ".$row1['alamat']." Kelurahan ".ucwords(strtolower($row1['kelurahan'])).", "
	        ...
	        ."Kecamatan ".ucwords(strtolower($row1['kecamatan'])).", ".ucwords(strtolower($row1['kota'])).", Provinsi ".ucwords(strtolower($row1['provinsi']));
