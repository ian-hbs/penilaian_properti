<?php	
	...
	$pdf->Cell(3,2.6,':',0,0,'C');
	$pdf->Cell(148,2.6,$row1['alamat'].", Kelurahan ".ucwords(strtolower($row1['kelurahan'])).", Kecamatan ".ucwords(strtolower($row1['kecamatan'])).",",'R');
	$pdf->Cell(0,2.6,'','R',1);

	$pdf->Cell(2,2.6,'','L');
	$pdf->Cell(33,2.6,'','L');			
	$pdf->Cell(148,2.6,ucwords(strtolower($row1['kota'])).", Provinsi ".ucwords(strtolower($row1['provinsi'])),'R');
	$pdf->Cell(0,2.6,'','R',1);
	...
	$regency = $global->identify_regency($row1['kota']);
	...
	$pdf->Cell(28,2.6,'');
	$pdf->SetFont('Arial','',6);
	$pdf->Cell(20,2.6,strtoupper($regency[0]));
	$pdf->Cell(3,2.6,':');
	$pdf->Cell(35,2.6,ucwords(strtolower($regency[1])));
	...
	$pdf->Cell(2,2.6,'','L');
	$pdf->Cell(55,2.6,'Hubungan dengan Calon Nasabah','L');
	$pdf->Cell(37,2.6,':   '.$row1['hubungan_dengan_calon_nasabah'],0);
	$pdf->Cell(89,2.6,'','R');
	$pdf->Cell(0,2.6,'','R',1);
	...
	$x=$pdf->GetX();
    $y=$pdf->GetY();
	$pdf->MultiCell($w,2.6,'Catatan : 1.',0,'R');
    ...
    $x=$pdf->GetX();
    $y=$pdf->GetY();
    $pdf->MultiCell($w,2.6,"Berdasarkan surat penugasan No. ".$row1['no_penugasan']." alamat properti berada di ".$row1['alamat'].", Kelurahan ".ucwords(strtolower($row1['kelurahan'])).", "
					."Kecamatan ".ucwords(strtolower($row1['kecamatan'])).", ".ucwords(strtolower($row1['kota'])).". Pada saat inspeksi lapangan, alamat lengkap properti berada di ".$row1['alamat'].", Kelurahan ".ucwords(strtolower($row1['kelurahan'])).", "
    				."Kecamatan ".ucwords(strtolower($row1['kecamatan'])).", ".ucwords(strtolower($row1['kota'])).", Provinsi ".ucwords(strtolower($row1['provinsi'])).".",0);
