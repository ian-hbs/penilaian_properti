...
<form id="<?=$id_form?>" class="form-horizontal form-label-left" method="POST" action="contents/<?=$fn?>/manipulating.php">
    ...
    <div class="form-group">
        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="nama">Nama Bahan<font color="red">*</font></label>
        <div class="col-md-8 col-sm-8 col-xs-12">
            <input type="text" id="nama" name="nama" value="<?=$curr_data['nama']?>" class="form-control col-md-7 col-xs-12" required>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="nilai">Nilai <font color="red">*</font></label>
        <div class="col-md-8 col-sm-8 col-xs-12">
            <input type="text" id="nilai" name="nilai" value="<?=$curr_data['nilai']?>" onkeypress="return only_number(event,this);" class="form-control col-md-7 col-xs-12" required>
        </div>
    </div>    
