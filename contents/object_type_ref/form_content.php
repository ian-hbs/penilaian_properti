...
<form id="<?=$id_form?>" class="form-horizontal form-label-left" method="POST" action="contents/<?=$fn?>/manipulating.php">
    ...
    <div class="form-group">
        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="<?=$id_name?>">ID Jenis Objek <font color="red">*</font></label>
    ...
    <div class="form-group">
        <label class="control-label col-md-4 col-sm-4 col-xs-12" for="jenis_objek">Jenis Objek <font color="red">*</font></label>
        <div class="col-md-8 col-sm-8 col-xs-12">
            <input type="text" id="jenis_objek" name="jenis_objek" value="<?=$curr_data['jenis_objek']?>" class="form-control col-md-7 col-xs-12" required>
        </div>
    </div>    
