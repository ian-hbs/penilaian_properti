<div class="box-header">
    <div class="row">
      <div class="col-md-6">
        <h3 class="box-title">Daftar Perusahaan Penunjuk</h3>
      </div>
            ...
            <table id='data-table-jq' class='table table-bordered table-striped'>
                    <thead>
                      <tr>
                        ...
                        <th>Kantor Cabang</th>
                        <th>Alamat</th>
                        <th>Kota/<br />Kode Pos</th>
                        <th>No. Kerjasama/<br />Tgl. Kerjasama</th>
                        <th>ID</th>
                        <th width='10%'>Aksi</th>
                      </tr>
                    </thead>
                    <tbody>";
                      ...
                      while($row = $list_of_data->FetchRow())
                      {
                          ...
                          <tr>
                            ...
                            <td>".$perusahaan_penunjuk."</td>
                            <td>".$kantor_cabang."</td>
                            <td>".$alamat."</td>
                            <td>".$kota."<br />".$kode_pos."</td>
                            <td>".$no_kerjasama."<br />".$tgl_kerjasama."</td>
                            <td>".$id_perusahaan_penunjuk."</td>
                            <td align='center'>";
                                if($editAccess)
                                ...
                                echo "
                                <input type='hidden' id='ajax-req-dt' name='id' value='".$id_perusahaan_penunjuk."'/>
