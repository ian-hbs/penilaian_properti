...
<html>
      ...
      if($n_row>0)
      {
        echo "
        <div class='header'>
          <img src='../../assets/images/logo.png' width='36px'/>
        </div>
        <div style='border:1px solid #000;margin-top:1cm;padding:2px'>
            ...
            <div style='border:2px solid #000;'>
              <ol type='1' style='margin:2px 0 2px 12px;'>
                <li>Bagian II diisi oleh PT. BTN (Persero)</li>
                <li>Bagian III diisi oleh Penilaian/Appraiser yang ditunjuk PT. BTN (Persero)</li>
              </ol>
            </div>
            <p class='point'>II. PETUNJUK/PENUGASAN PENILAIAN : DIISI OLEH PT. BTN (Persero)</p>
            ...
            <p class='point'>III. LAPORAN HASIL PENILAIAN, DIISI OLEH PENILAI/APPRAISER YANG DITUNJUK PT. BTN (Persero)</p>
            <table class='main' style='border:2px solid #000' cellpadding=0 cellspacing=0>
              <tr>
              ...
              <tr>
                <td width='50%' valign='top'>
                  <table class='main' style='border:1px solid #000;' cellpadding=0 cellspacing=0>";
                    ...
                    $label = "Kecepatan Pertambahan Nilai Nilai";
                    for($i=0;$i<count($arr_opt);$i++)
                    {
                      $style = "border:1px solid #000;border-top:none;";
                      if($i==(count($arr_opt)-1))
                ...
                <td width='50%' valign='top'>
                  <table class='main' style='border:1px solid #000;' cellpadding=0 cellspacing=0>";
                    ...
                    for($i=0;$i<count($arr_opt);$i++)
                    {
                      ...
                      $checked = (in_array($arr_opt[$i],$x_sff)==$arr_opt[$i]?'X':'&nbsp;');
                      echo "
                      <tr>
                        <td style='".$style1."'>".($i==0?$label:'&nbsp;')."</td>
                        <td style='".$style2."' align='center'><b>".$checked."</b></td>
      ...
      else
      {
        echo "<br />
              <center>
                Data tidak ditemukan atau data yang dicari belum lengkap. Pastikan data pada menu (1), (4), (5) & (6) telah diisi
              </center>";
      }
      ?>
  	</body>
